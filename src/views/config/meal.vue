  ...
  <div class="appContainer">
    ...
    <div class="mainWrapper">
      <div class="mainHeader mainHeader1">
        ...
        <div class="searchBar">
          <el-button type="primary" @click="addMealFn()"><i class="el-icon-plus"></i>新增</el-button>
        </div>
      </div>
      <div class="mainContent">
        <el-table ref="multipleTable" :data="tables" @cell-mouse-enter="cellEnter" border fit highlight-current-row>
          ...
          <el-table-column prop="picAddress" label="套餐图片" width="170px" align="center" sortable>
            <template slot-scope="scope">
              <img :src="scope.row.picAddress" style="display:block;margin:0 auto;width: 130px; height: 80px">
            </template>
          </el-table-column>
          <el-table-column prop="detail" label="套餐详情" align="center" sortable />
          <el-table-column prop="price" label="价格（元）" width="120px" align="center" sortable />
          <el-table-column prop="status" label="状态" width="100px" align="center" :formatter="statusFormatter" sortable>
            <template slot-scope="scope">
          ...
          <el-table-column prop="createTime" label="创建日期" width="250px" align="center" sortable />
    ...
    <el-dialog :title="title" :visible.sync="formVisit" :close-on-click-modal="false" :close-on-press-escape="false"
      width="30%" @close="closeDialog('form')">
      <el-form ref="form" class="dialogBody" :rules="AddEditRules" :model="form" label-width="100px"
        label-position="right">
        <el-row>
          <el-col :span="24">
            <el-form-item label="图片" prop="name">
              <el-upload ref="upload" :class="{ hide: hideUpload }" list-type="picture-card" action="#"
                :on-change="handleChange" :on-remove="handleRemove" :on-exceed="handleExceed" :auto-upload="false"
          ...
          <el-col :span="24">
            <el-form-item label="详情" prop="detail">
              <el-input v-model="form.detail" type="textarea" :rows="6" placeholder="请输入详情" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
