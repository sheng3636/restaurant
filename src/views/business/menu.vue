      ...
      <div class="main-header">
        <el-row>
          ...
          <el-col :md="18" class="tableHeadRow">
            <el-button type="primary" size="mini" @click="addMenuFn()">新增</el-button>
          </el-col>
        </el-row>
      </div>     
      <div class="main-content">
        <el-table ref="multipleTable" :data="tables" border fit highlight-current-row>
          ...
          <el-table-column prop="price" label="套餐价格"  align="center" sortable />
          <el-table-column prop="detail" label="详情"  align="center" sortable />
          <el-table-column prop="picAddress" label="图片地址"  align="center" sortable />
        ...
        <el-row>
                ...
                <el-col :span="12">
                  <el-form-item label="图片地址" prop="picAddress">
                      <el-input v-model="form.picAddress" placeholder="请输入图片地址" />
                  </el-form-item>
                </el-col>
