<template>
  <div class="appContainer">
    <div class="mainWrapper">
      <div class="mainHeader"><span class="title">部门查询</span>
        <el-form class="searchBar" ref="queryParams" :model="queryParams" label-width="80px" label-position="top">
          <el-form-item label="" prop="departmentName">
            <el-input v-model="queryParams.departmentName" placeholder="请输入部门名称" />
          </el-form-item>
          <div class="btnGroup">
    ...
    <div class="mainWrapper">
      <div class="mainHeader mainHeader1">
        ...
        <div class="searchBar">
          <el-button type="primary" @click="addDepartmentFn()"><i class="el-icon-plus"></i>新增</el-button>
        </div>
      </div>
      <div class="mainContent">
        <el-table ref="multipleTable" :data="tables" :cell-style="statusStyle" border fit highlight-current-row>
          ...
          <el-table-column prop="userNum" label="使用数量" align="center" sortable />
    ...
    <el-dialog :title="title" :visible.sync="formVisit" :close-on-click-modal="false" :close-on-press-escape="false"
      ...
      <el-form ref="form" class="dialogBody" :rules="AddEditRules" :model="form" label-width="80px"
